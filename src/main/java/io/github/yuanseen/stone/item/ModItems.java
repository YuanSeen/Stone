...
//    public static final Item EGG = registerItem("egg", new EggItem(new Item.Properties().stacksTo(16)));
    ...
    public static final Supplier<Item> GOLDEN_TANGERINE = ITEMS.register("golden_tangerine.json",() -> new Item(new Item.Properties().rarity(Rarity.RARE).food(ModFoods.GOLDEN_TANGERINE)));
