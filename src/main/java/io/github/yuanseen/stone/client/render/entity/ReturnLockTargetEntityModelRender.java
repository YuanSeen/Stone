...
public class ReturnLockTargetEntityModelRender extends EntityRenderer {

    private EntityModel<ReturnLockTargetEntity> model;

    public ReturnLockTargetEntityModelRender(EntityRendererProvider.Context pContext) {
        super(pContext);
        ...
        model = new ReturnLockTargetEntityModel(pContext.bakeLayer(ReturnLockTargetEntityModel.LAYER_LOCATION));
    }

    @Override
    public ResourceLocation getTextureLocation(net.minecraft.world.entity.Entity pEntity) {
        return new ResourceLocation(Stone.MOD_ID, "textures/entity/return_lock_target_entity.png");
    }
